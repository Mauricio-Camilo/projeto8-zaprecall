...
function PaginaPerguntas() {
    ...
    const [parabens,setParabens] = React.useState(true);
        ...
        <div className="tela-principal">
            <div className="tela-2">
                ...
                <div className="container">
                    ...
                    array={array} setArray={setArray} setParabens={setParabens}/>
                    )}
                </div>
                {contador>=1?
                <ConcluidosIcones contagem={contador} comprimento={listaPerguntas.length} 
                icone={icone} array={array} setArray={setArray} parabens={parabens}/>:
